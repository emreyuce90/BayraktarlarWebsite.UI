...
namespace BayraktarlarWebsite.DAL.Migrations
{
    ...
    [Migration("20220930132230_mig_22")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BayraktarlarWebsite.Entities.Entities.AltMarka", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BayraktarlarWebsite.Entities.Entities.Ciro", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BayraktarlarWebsite.Entities.Entities.Hedef", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("AltMarkaId")
                        .HasColumnType("int");

                    b.Property<int>("TargetPerMonth")
                        .HasColumnType("int");

                    b.Property<int>("TargetPerYear")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BayraktarlarWebsite.Entities.Entities.Marka", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BayraktarlarWebsite.Entities.Entities.Sellout", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BayraktarlarWebsite.Entities.Entities.Tahsilat", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BayraktarlarWebsite.Entities.Entities.User", b =>
                {
                    ...
                    b.Property<bool>("IsRepresentive")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("BayraktarlarWebsite.Entities.Entities.AltMarka", b =>
                {
                    b.HasOne("BayraktarlarWebsite.Entities.Entities.Marka", "Marka")
                        .WithMany("AltMarkalar")
            ...
            modelBuilder.Entity("BayraktarlarWebsite.Entities.Entities.Hedef", b =>
                {
                    b.HasOne("BayraktarlarWebsite.Entities.Entities.AltMarka", "AltMarka")
                        .WithMany()
                        .HasForeignKey("AltMarkaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("BayraktarlarWebsite.Entities.Entities.User", b =>
                {
                    b.Navigation("Cirolar");

                    b.Navigation("Hedefler");

                    b.Navigation("Sellouts");
